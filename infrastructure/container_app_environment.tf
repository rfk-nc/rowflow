module "container-app-environment" {
  ...
  vnet_integration_subnet_id = var.features.vnet_integration_enabled ? module.subnets["${module.regions_config[each.value.region].names.subnet}-container-app-${lower(each.value.container_app_environment)}"].id : null
