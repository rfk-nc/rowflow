module "vnet" {
  ...
  monitor_diagnostic_setting_vnet_enabled_logs = var.features.diagnostics_enabled ? local.monitor_diagnostic_setting_vnet_enabled_logs : null
  monitor_diagnostic_setting_vnet_metrics      = var.features.diagnostics_enabled ? local.monitor_diagnostic_setting_vnet_metrics : null
...
/*--------------------------------------------------------------------------------------------------
  Create peering
--------------------------------------------------------------------------------------------------*/
# TODO: Uncomment the peering module when the hub is deployed
