module "log_analytics_workspace" {
  ...
  monitor_diagnostic_setting_log_analytics_workspace_enabled_logs = var.features.diagnostics_enabled ? local.monitor_diagnostic_setting_log_analytics_workspace_enabled_logs : null
  monitor_diagnostic_setting_log_analytics_workspace_metrics      = var.features.diagnostics_enabled ? local.monitor_diagnostic_setting_log_analytics_workspace_metrics : null
